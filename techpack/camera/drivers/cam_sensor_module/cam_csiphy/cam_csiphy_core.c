	...
	struct cam_config_dev_cmd *cfg_dev)
{
	...
	if (cam_cmd_csiphy_info->secure_mode == 1)
		cam_csiphy_update_secure_info(csiphy_dev,
			cam_cmd_csiphy_info, cfg_dev, index);
...
reset_settings:
	...
	cam_mem_put_cpu_buf(cfg_dev->packet_handle);
	cam_mem_put_cpu_buf(cmd_desc->mem_handle);
>>>>>>> 4b455c21d579 (Merge tag 'LA.UM.9.12.r1-15600-SMxx50.0' of https://git.codelinaro.org/clo/la/platform/vendor/opensource/camera-kernel into android13-4.19-kona)
	return rc;
}
